  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 h-full">
        {/* Navigation */}
        <nav className="fixed top-0 left-0 right-0 z-10 px-6 py-4 flex justify-between items-center bg-gray-700">
          ...
          <div className="hidden md:flex space-x-8">
            ...
            <a href="#statut" className="hover:text-blue-200 transition-colors">
            ...
            <a
              href="#contact"
              className="px-4 py-2 bg-emerald-900 bg-opacity-10 hover:bg-opacity-20 hover:bg-emerald-800 rounded-full transition-colors"
            >
              Contact
            </a>
          </div>
        ...
        <div className="mx-auto h-full flex flex-col justify-center items-center text-center px-6">
          ...
          >
            Demandez rapidement vos relevés de notes, attestations, diplômes,
            etc. sans vous déplacer
          </motion.p>
