...
export default function DemandeSection() {
  ...
  const actesTypes = [
    ...
    },
    {
      ...
      description: "Demandez votre attestation de succès de master",
  ...
  const handlePaymentSuccess = async (paymentResponse: any) => {
    ...
    try {
      ...
      if (formData.acteNaissance)
        formDataToSend.append("acteNaissance", formData.acteNaissance);
      if (formData.carteEtudiant)
        formDataToSend.append("carteEtudiant", formData.carteEtudiant);
      ...
      if (formData.demandeManuscrite)
        formDataToSend.append("demandeManuscrite", formData.demandeManuscrite);
  ...
  const handleTresorPayButton = () => {
    ...
    if (!formData.email) {
      alert("Veuillez saisir votre email avant de procéder au paiement.");
      return;
    }
    ...
    try {
      ...
      const documentTitle =
        actesTypes.find((acte) => acte.id === formData.acteType)?.title ||
        "document";
      ...
      if (typeof window !== "undefined" && window.TresorPay) {
        try {
          ...
          if (
            tresorPayWidgetRef.current &&
            typeof tresorPayWidgetRef.current.open === "function"
          ) {
  ...
  useEffect(() => {
    if (
      ...
      try {
        const nameParts = studentFullName
          ? studentFullName.split(" ")
          : ["", ""];
        const firstName = nameParts[0] || "";
        const lastName = nameParts.slice(1).join(" ") || "";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-900">
                  {actesTypes.find((acte) => acte.id === formData.acteType)
              ...
              <div>
                ...
                <p className="text-gray-900">
                  {formData.matricule || "Non renseigné"}
                </p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-700">
                ...
                <p className="text-gray-900">
                  {formData.etablissement || "Non renseigné"}
                </p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-700">
                ...
                <p className="text-gray-900">
                  {formData.anneeEtude || "Non renseignée"}
                </p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-700">
                ...
                <p className="text-gray-900">
                  {formData.anneeAcademique || "Non renseignée"}
                </p>
              </div>
              {studentVerification && (
                <div>
                  ...
                  <ul className="text-gray-900 list-disc list-inside">
                    ...
                    <li>
                      Date de naissance: {studentVerification.datenaissance}
                    </li>
                    <li>
                      Lieu de naissance: {studentVerification.lieunaissance}
                    </li>
          ...
          <div className="flex flex-col justify-center">
            <p className="text-gray-600 mb-6 text-center">
              Choisissez votre méthode de paiement TresorPay
            </p>
                ...
                <div>
                  ...
                  >
                    ...
                    {formData.etablissement &&
                      (studyYearsByEstablishment as any)[
                        formData.etablissement
                      ]?.map((year: any, index: any) => (
            ...
            >
              ...
              <div className="flex justify-between pt-4">
                ...
                <button
                  ...
                  className="px-6 py-3 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-lg transition-colors flex items-center"
                  disabled={
                    !formData.acteType || !formData.email || !formData.telephone
                  }
                >
